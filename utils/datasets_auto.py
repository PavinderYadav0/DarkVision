    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            ...
            if (k<50):
                ...
                im0s= cv2.addWeighted(im0s, 2, im0s, 0, 10)
                im0s=cv2.normalize(im0s, im0s, 30, 200, cv2.NORM_MINMAX)
                img0 = cv2.GaussianBlur(im0s, (5, 5), 0)

            else:
                img0= cv2.normalize(im0s, im0s, 0, 255, cv2.NORM_MINMAX)
...
def load_image(self, index):
    ...
    if img is None:  # not cached
        ...
        img = cv2.GaussianBlur(im0s, (5, 5), 0)
